...
comR = {'R0': '0000000000000000', 'R1': '0000000000000000', 'R2': '0000000000000000', 'R3': '0000000000000000', 'R4': '0000000000000000', 'R5': '0000000000000000', 'R6': '0000000000000000',
        'FLAGS': '0000000000000000', 'r0': '0000000000000000', 'r1': '0000000000000000', 'r2': '0000000000000000', 'r3': '0000000000000000', 'r4': '0000000000000000', 'r5': '0000000000000000', 'r6': '0000000000000000'}
...
if len_check == 1:
    while (int(eval(PC), 2) < len(machine_code)):
        i = eval(PC)
        ...
        if instr_len_check:
            ...
            if type == 'A':
                ...
                if instruction_list[0] == '10110':  # load reg1 mem
